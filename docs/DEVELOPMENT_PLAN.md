...
- [ ] **편집완료 (handleFinish)**
  ...
  - [ ] 썸네일 생성
  - [ ] PDF 생성 요청
  - [ ] 쇼핑몰 콜백 호출 (onComplete)
- [ ] **내 작업에 저장 (handleSaveWork)**
  - [ ] 세션 데이터 저장
  - [ ] 자동 저장
- [ ] **불러오기 (handleOpenWorkspace)**
  - [ ] 저장된 작업 목록
  - [ ] 작업 불러오기
...
1. **편집완료 기능 구현** (Phase 4.2)
   - 캔버스 저장 → 썸네일 생성 → PDF 요청 → 콜백

2. **내 작업에 저장 구현** (Phase 4.2)
   - 세션 저장 API 연동
